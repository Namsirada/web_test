...
Route::delete('/delete-profile/{id}', [App\Http\Controllers\ProfileController::class, 'delProfile']);

//Route::DELETE('delProfile/{id}', [App\Http\Controllers\ProfileController::class, 'delProfile']);
